...
extension Droplet {
    func setupRoutes() throws {
        get("campaigntimes") { req in
            ...
            try json.set("campaigns", [["valentines" : ["start": Date.with(year: 2018, month: 2, day: 14, hour: 0, minute: 0),
                                                        "end": Date.with(year: 2018, month: 2, day: 15, hour: 0, minute: 0)]],
                                       ["christmas": ["start": Date.with(year: 2018, month: 12, day: 20, hour: 0, minute: 0),
                                                      "end": Date.with(year: 2018, month: 12, day: 25, hour: 0, minute: 0)]],
                                       ["xfactor": ["start": Date.with(year: 2018, month: 9, day: 20, hour: 0, minute: 0),
